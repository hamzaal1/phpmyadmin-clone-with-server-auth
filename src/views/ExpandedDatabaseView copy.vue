                                ...
                                <div class="">
                                    ...
                                    <div v-for="(row,index) in rows_number" :key="index" class="mb-4 d-flex">
                                        <div class="col-8">
                                            ...
                                            <input v-model="row.name" :type="row.type" class="form-control" id="example-text-input" name="example-text-input" placeholder="New Colmun">
                                        </div>
                                        <select v-model="row.type" class="form-control h-25 mt-4 py-2" name="" id="">
                                            <option selected value="text">varchar</option>
